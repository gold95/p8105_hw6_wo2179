...
```{r}
q1 = ggplot(baby_res, aes(x = blength, y = resid)) + geom_boxplot()
q2 = ggplot(baby_res, aes(bhead, resid)) + geom_boxplot()
q3 = ggplot(baby_res, aes(gaweeks, resid)) + geom_boxplot()
q4 = ggplot(baby_res, aes(smoken, resid)) + geom_boxplot()
q5 = ggplot(baby_res, aes(wtgain, resid)) + geom_boxplot()
q6 = ggplot(baby_res, aes(momage, resid)) + geom_boxplot()
