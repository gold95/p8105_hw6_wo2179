...
```
Both estimates had a normal curve. R_hat squared had a tall and skinny curve while the log estimate had a short and fat curve. This signifies that R_hat squared had a lesser standard deviation compared with log estimate.
